...
<div id="comments" {if (!isset($comment_add) && ($COMMENT_COUNT == 0))}class="noCommentContent"{else}class="commentContent"{/if}><div id="commentsSwitcher"></div>
  <h3>{$COMMENT_COUNT|translate_dec:'%d bản tin':'%d bản tin'}</h3>
  <div id="pictureComments">
    ...
    <div id="commentAdd" style="position: static; top: 0px;">
      ...
      <form method="post" action="{$comment_add.F_ACTION}" id="addComment">
        ...
        <p><textarea name="content" id="contentid" rows="5" cols="50" style="width: 100%; max-width: 100%; box-sizing: border-box; margin: 10px 0; min-height: 100px; resize: vertical;">{$comment_add.CONTENT}</textarea></p>
